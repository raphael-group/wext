...
ax1.set_xlabel('Permutational $p$-value')
ax1.set_ylabel('Unweighted (CoMet) $p$-value')
ax1.set_xscale('log')
ax1.set_yscale('log')
...
ax2.set_xlabel('Permutational $p$-value')
ax2.set_ylabel('Weighted $p$-value (saddlepoint)')
ax2.set_xscale('log')
ax2.set_yscale('log')
